...
import mbti.semin.service.MbtiService;
import mbti.semin.service.MbtiServiceSemin;


@WebServlet("*.mbti")
public class MbtiControllerSemin extends HttpServlet {
...
protected void doAction(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	...
	MbtiService service = new MbtiServiceSemin();
